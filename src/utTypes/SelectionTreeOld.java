...
//
//
//public class SelectionTreeOld<T> extends TreeComposedClass<SelectionTree<T>.SelectionData> {
//	
//	public Function<TreeNode<SelectionData>,TreeNode<SelectionData>> defaultTraverseFn = 
//			n -> n.get( indexByWeight(n) );
//	
//	
//	public SelectionTreeOld(){
//		super();
//		root.setData( new SelectionData() );
//	}
//	
//	public SelectionTreeOld( SelectionData data ){
//		super();
//		root.setData( data );
//	}
//	
...
//		for( SelectionData sd : input ) root.addChild( new SelectionTreeOld<T>( sd ) );
//	}
